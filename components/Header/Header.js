              ...
              <header id={styles.FIXED_HEADER}> 
                  ...
                  <div class="content-center ..." id={styles.NAV_MENU}>                       
                      ...
                      <Link id={styles.PRODUCTS} href="/products"> 
                        <h3 id={styles.H_3_PRODUCTS} class="text-center ...  text-slate-50  font-avant_garde_bold" data-content="Products">Products</h3>
                      </Link>  

                      <Link id={styles.PROJECTS} href="/projects"> 
                        <h3 id={styles.H_3_PROJECTS} class="text-center ...  text-slate-50  font-avant_garde_bold" data-content="Projects">Projects</h3>
                      </Link>  
