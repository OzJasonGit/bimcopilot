              ...
              <header id={styles.FIXED_HEADER}> 
                  ...
                  <div class="content-center ..." id={styles.NAV_MENU}>  
                      ...
                      <Link class="content-center ..." id={styles.SERVICES} href="/services"> 
                        <h3 id={styles.H_3} class="text-center ...  text-slate-50 font-avant_garde_bold">Services</h3>
                      </Link>  

                      <Link id={styles.PRODUCTS} href="/products"> 
                        <h3 id={styles.H_3} class="text-center ...  text-slate-50  font-avant_garde_bold">Products</h3>
                      </Link>  

                      <Link id={styles.PROJECTS} href="/projects"> 
                        <h3 id={styles.H_3} class="text-center ...  text-slate-50  font-avant_garde_bold">Projects</h3>
                      </Link>  

                      <Link id={styles.STORIES} href="/bloghome"> 
                        <h3 id={styles.H_3} class="text-center ...  text-slate-50 font-avant_garde_bold">Stories</h3>
                      </Link>  
