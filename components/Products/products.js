              ...
              {products.map((product, index) => (
                <div key={index} id={styles.PRODUCT} style={{ gridArea: `AREA_${index + 1}` }}>
                  ...
                  <Link
                    ...
                    <div id={styles.PRODUCT_OVERLAY_GRID} style={{ position: "absolute", width: "100%", height: "100%",  left: "-100%", top:"0px"}}>

                      <div style={{ gridArea: "LOGO", position: "relative", left: "100%", zIndex: 100}} className=" opacity-0 -translate-x-10 transition-all duration-500 group-hover:translate-x-0 group-hover:opacity-100">
                      ...
                      <div style={{ gridArea: "TEXT", position: "relative", left: "100%", zIndex: 100}} className=" opacity-0  translate-x-10 transition-all duration-500 group-hover:translate-x-0 group-hover:opacity-100" >
