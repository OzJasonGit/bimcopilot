  ...
  const router = useRouter();
   ...
   return (
    ...
    <>
              ...
              <div id={styles.SUBSCRIBE} class={"border-emerald-200"}>
                ...
                <div id={styles.MAIN_TAG}>
                  <h1
                    ...
                    class="text-center ... text-7xl ... text-stone-200 ... font-avant_garde_bold"
                  >        
          ...
          <div class={styles.grid_0_scroll}>      
            <div id={styles.PORTFOLIO_TITLE}>
              ...
              <div id={styles.IMAGE_LAYER_1}>
                <div class="rounded-xl ... drop-shadow-2xl ..." id={styles.P_IMAGE_1}>
                </div>
              </div>
              
              <div id={styles.IMAGE_LAYER_2}>    
                <div class="rounded-xl ... drop-shadow-2xl ..." id={styles.P_IMAGE_2}>                  
                </div>
                <div class="rounded-xl ... drop-shadow-2xl ..." id={styles.P_IMAGE_3}>                 
                </div>           
              </div>
      ...
      <section id={styles.SHADOW_SECTION_BLOG} class={styles.center_holder}>
          <div class={styles.grid_0_client_key}> 
            <div class={styles.client_key_problem}>
              <div id={styles.SUBSCRIBE} class={"border-emerald-200"}>
                <div id={styles.SUB_ICON}>
      ...
      <section id={styles.SHADOW_SECTION_BLOG} class={styles.center_holder}>
          <div class={styles.grid_0_collapse}>
      ...
      <section id={styles.SHADOW_SECTION_BLOG} class={styles.center_holder}>
          <div class={styles.grid_0_how_we_work}>   
              ...
              <div id={styles.WORKING_IMAGES}>  
                <div class="border-8 border-stone-200 ... rounded-lg ..." id={styles.HOW_WE_WORK_IMAGE}>
                </div>                 
              </div> 
      ...
      <section id={styles.SHADOW_SECTION_BLOG} class={styles.center_holder}>
          <div class={styles.grid_0_packages}>
              ...
              <div id={styles.PACKAGES_IMAGES}> 
                ...
                <div class="bg-red-200 rounded-xl ..." id={styles.PACKAGE_1}>
                </div>  
                <div class="bg-red-200 rounded-xl ..." id={styles.PACKAGE_2}>
                </div> 
                <div class="bg-red-200 rounded-xl ..." id={styles.PACKAGE_3}>
                </div>  
          ...
          <div class={styles.grid_0_client_showcase}>
              ...
              <div id={styles.HOW_WE_WORK_BLOCK}>   
                <div  id={styles.WHO_WEVE_HELPED}>
                  <div class="bg-neutral-900 rounded-xl ... shadow-2xl shadow-black"id={styles.WHO_WEVE_HELPED_TEXT}> 
          ...
          <div class={styles.grid_0_client_showcase}>
              ...
              <div id={styles.FAQ_BLOCK}>   
                ...
                <div  id={styles.FAQ}>
                  ...
                  <div class="bg-red-200 rounded-xl ..."id={styles.FAQ_TEXT}>                                        
                  </div>
                </div>  
          ...
          <div class={styles.grid_0_client_showcase}>
              ...
              <div id={styles.IS_THIS_FOR_ME_BLOCK}>   
                <div  id={styles.IS_THIS_FOR_ME}>
                  <div class="bg-red-200 rounded-xl ..."id={styles.IS_THIS_FOR_ME_TEXT}>   
                    <div class="bg-red-200 rounded-xl ..."id={styles.IS_THIS_FOR_ME_HOLDER}>
                    </div>                
                  </div>
                </div>                  
              </div> 
