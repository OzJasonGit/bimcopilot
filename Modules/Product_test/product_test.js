                    ...
                    {group.slice(0, 3).map((product) => (
                      <div key={product.id} className={styles.card}>
                        ...
                        <Link href={`/products/${product.slug}`}
                          ...
                          <div class={styles.imageWrapper} className="relative w-full h-full transition-transform duration-500 ease-in-out transform-gpu origin-center scale-110 group-hover:scale-100 ">
                            <Image
                              src={product.image}
                              alt={product.title}
                              fill
