...
import { faLinkedin, faSquareXTwitter, faSquareFacebook, faSquareReddit, faYoutube,  faInstagram} from '@fortawesome/free-brands-svg-icons' 
                ...
                <div class={styles.grid_0_dashboard}>
                    <div id={styles.DASHBOARD_GRID}>
                        ...
                        <div id={styles.MAP_GRID_CONTAINER}> 
                            ...
                            <div id={styles.CHART_GRID_2_CONTAINER} className="rounded-xl ..."
                                     style={{
                                        gridArea: "CHART_2",
                                        position: "relative",
                                        overflow: "hidden",
